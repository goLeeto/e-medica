...
$(document).ready(function() {
	...
	$('.sp .tabs li').each(function(){
		...
		$(this).mouseover(function(){
			...
			if($(this).index()==0){
			$('#sh_color').animate({"margin-left":"500px","width":"120px"},250);
			}else if($(this).index()==1){
			$('#sh_color').animate({"margin-left":"620px","width":"160px"},250);
		 }else if($(this).index()==2){
			$('#sh_color').animate({"margin-left":"780px","width":"170px"},250);
		 	} else if($(this).index()==3){
			$('#sh_color').animate({"margin-left":"950px","width":"175px"},250);
		}
		});
...
function changePanels(newIndex){
	...
	var newPanelHeight = "450px";
	
	var newPanelHeight1 = "700px";
